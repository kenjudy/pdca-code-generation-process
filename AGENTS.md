...
│       └── references/
│           ├── *-beads-addon.md  ← SOURCE: beads phase additions
│           ├── beads-setup.md    ← SOURCE: first-time beads install guide
│           └── beads-workflow.md ← SOURCE: per-session beads reference
│           └── build/           ← BUILD ARTIFACT: generated by build-skill.sh
